...
//  await Trolleys.updateTrolleys(parsingTcpBufferData(decodedBufferData));
    ...
    //     break;
    //   case 2:
    //     tcpcommand.makeBeepSound(tagsBufferObjData, 4, 20 ); //4 second dura>
...
//   default:
    ...
    if(tagsBufferObjData.tags.length==1){
        tagsBufferObjData.tags=tagsBufferObjData.tags[0]
          ...
          tcpcommand.makeBeepSound(tagsBufferObjData, 4, 20 ); //4 second duratio>
...
var cors = require('cors')
const { WebSocket, WebSocketServer } = require('ws');
// const { trolleyEvents,inactiveMarkingScheduler } = require("./controllers/tr>
// const { inOutRecords } = require("./controllers/trolley_in_Out_Recods");
